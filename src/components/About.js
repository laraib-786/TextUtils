...
export default function About() {
    ...
    // }
    // const [myStyle,UpdateMyStyle]=useState(); can't use this after declaring myStyle will receive error:  mystyle alreay declared
    
    // initilizing myStyle and assigning it values with useState hook
            ...
            <div className="accordion accordion-flush" id="accordionFlushExample">
                <div className="accordion-item">
                    ...
                    <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        <div className="accordion-body" style={myStyle}>Placeholder content for this accordion, which is intended to demonstrate the className. This is the first item's accordion body.</div>
                    </div>
                </div>
                <div className="accordion-item">
